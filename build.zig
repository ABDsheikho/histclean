...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("histclean", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "histclean" is the name you will use in your source code to
                // import this module (e.g. `@import("histclean")`). The name is
    ...
    // Integration tests that spawn the built binary
